        ...
        <div class="address-inner">
            ...
            <form method="POST" action="{{ route('purchase.address.update', $item) }}" class="address-form">
                ...
                <div class="address-form__group">
                    ...
                    <input class="address-form__input" type="text" name="shipping_postal_code" value="{{ old('shipping_postal_code') }}">
                ...
                <div class="address-form__group">
                    ...
                    <input class="address-form__input" type="text" name="shipping_address" value="{{ old('shipping_address') }}">
